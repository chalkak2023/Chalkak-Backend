...
var PhotospotController = /** @class */ (function () {
    ...
    PhotospotController.prototype.createPhotospot = function (createPhtospotDto, collectionId) {
        this.photospotService.createPhotospot(createPhtospotDto, 1, collectionId);
    };
    PhotospotController.prototype.getAllPhotospot = function (collectionId) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.photospotService.getAllPhotospot(collectionId)];
            });
        });
    };
    PhotospotController.prototype.getPhotospot = function (param) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.photospotService.getPhotospot(param)];
            });
        });
    };
    ...
    __decorate([
        ...
        __param(0, common_1.Body()), __param(1, common_1.Param('collectionId'))
    ], PhotospotController.prototype, "createPhotospot");
    __decorate([
        common_1.Get('/:collectionId'),
        __param(0, common_1.Param('collectionId'))
    ], PhotospotController.prototype, "getAllPhotospot");
    __decorate([
        common_1.Get('/:collectionId/photospots/:photospotId'),
        __param(0, common_1.Param())
    ], PhotospotController.prototype, "getPhotospot");
    __decorate([
        common_1.Put('/:collectionId/photospots/:photospotId'),
        form_data_1.FormDataRequest(),
